...
- Traps (7 kinds, hidden until stepped on: trap door to the next level, bear trap, sleeping gas, arrow, teleport, poison dart, rust) and hidden doors (from level 3 down; look like wall). When no unexplored area is left and the stairs are unknown, the pilot gets a "search" action that walks dead ends and room walls and searches for hidden doors (1 in 5 per turn next to one). This can take a few hundred turns and costs food.
